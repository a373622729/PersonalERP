    ...
    e.prototype = {
        constructor: e, render: function () {
            ...
            if (this.options.multiSelect ? t.each(n, function (e, n) {
                ...
                }) : n[0] !== i[0] && (n.removeClass("tree-selected").find("i").first().removeClass("fa fa-check").addClass("tree-dot"), r.push(i.data())), this.options.selectable) {
                var o = "selected";
                i.hasClass("tree-selected") ? (o = "unselected", i.removeClass("tree-selected"), i.find("i").first().removeClass("fa fa-check").addClass("tree-dot")) : (i.addClass("tree-selected"), i.find("i").first().removeClass("tree-dot").addClass("fa fa-check"), this.options.multiSelect && r.push(i.data()))
            }
