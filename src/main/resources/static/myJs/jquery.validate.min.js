...
(function (t) {
    t.extend(t.fn, {
        ...
        messages: {
            ...
            number: "请输入合法的数字.",
            digits: "仅允许输入数字.",
            creditcard: "请输入正确的身份证号码.",
            equalTo: "请输入与上一项相同的值.",
            maxlength: t.validator.format("最多输入 {0} 个字符."),
            minlength: t.validator.format("最少输入 {0} 个字符."),
            rangelength: t.validator.format("请输入长度为 {0} 至 {1} 的字符."),
            range: t.validator.format("请输入值在 {0} 至 {1}."),
            max: t.validator.format("请输入小于等于 {0} 的值."),
            min: t.validator.format("请输入大于等于 {0} 的值.")
        },
        autoCreateRanges: !1,
        prototype: {
            init: function () {
